...
export default class Swarm {
  ...
  sendInvite({ peerId, requestId, encryptedInvite }, timeout) {
    // Self-resolve
    if (peerId.equals(this.vowlink.id)) {
      this.vowlink.resolveInvite(requestId, encryptedInvite);
      return WaitList.resolve(null);
    }
